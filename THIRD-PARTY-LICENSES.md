 ...
 * ch.admin.bit.jeap:jeap-error-handling-service - [ch.admin.bit.jeap:jeap-error-handling-service](https://github.com/jeap-admin-ch/jeap-error-handling/tree/main/jeap-error-handling-service)
 * ch.admin.bit.jeap:jeap-error-handling-ui - [ch.admin.bit.jeap:jeap-error-handling-ui](https://github.com/jeap-admin-ch/jeap-error-handling/tree/main/jeap-error-handling-ui)
 ...
 * ch.admin.bit.jeap:jeap-messaging-idempotence - [ch.admin.bit.jeap:jeap-messaging-idempotence](https://github.com/jeap-admin-ch/jeap-messaging/tree/main/jeap-messaging-idempotence)
 ...
 * ch.admin.bit.jeap:jeap-messaging-sequential-inbox-rest-api - [ch.admin.bit.jeap:jeap-messaging-sequential-inbox-rest-api](https://github.com/jeap-admin-ch/jeap-messaging-sequential-inbox/tree/main/jeap-messaging-sequential-inbox-rest-api)
 ...
 * ch.admin.bit.jeap:jeap-open-api-publisher-starter - [ch.admin.bit.jeap:jeap-open-api-publisher-starter](https://github.com/jeap-admin-ch/jeap-open-api-publisher/tree/main)
 ...
 * ch.admin.bit.jeap:jeap-reaction-observer-starter - [ch.admin.bit.jeap:jeap-reaction-observer-starter](https://github.com/jeap-admin-ch/jeap-reaction-observer/tree/main/jeap-reaction-observer-starter)
 ...
 * ch.admin.bit.jeap:jeap-spring-boot-audit-starter-transactional-outbox - [ch.admin.bit.jeap:jeap-spring-boot-audit-starter-transactional-outbox](https://github.com/jeap-admin-ch/jeap-audit/tree/main/jeap-spring-boot-audit-starter-transactional-outbox)
 ...
 * jme-messaging-common-lib - [ch.admin.bit.jeap:jme-messaging-common-lib](https://github.com/jme-admin-ch/jme-messaging-example/tree/main/jme-messaging-common-lib)
 ...
 * ch.admin.bit.jeap.jme.messagetype.jme:jme-create-declaration-v2-command - [ch.admin.bit.jeap.jme.messagetype.jme:jme-create-declaration-v2-command](https://github.com/jme-admin-ch/jme-message-type-registry/tree/main)
 * ch.admin.bit.jeap.jme.messagetype.jme:jme-declaration-created-event - [ch.admin.bit.jeap.jme.messagetype.jme:jme-declaration-created-event](https://github.com/jme-admin-ch/jme-message-type-registry/tree/main)
 ...
 * ch.admin.bit.jeap.jme.messagetype.jme:jme-order-created-event - [ch.admin.bit.jeap.jme.messagetype.jme:jme-order-created-event](https://github.com/jme-admin-ch/jme-message-type-registry/tree/main)
 * ch.admin.bit.jeap.jme.messagetype.jme:jme-order-prepared-event - [ch.admin.bit.jeap.jme.messagetype.jme:jme-order-prepared-event](https://github.com/jme-admin-ch/jme-message-type-registry/tree/main)
 * ch.admin.bit.jeap.jme.messagetype.jme:jme-order-shipped-event - [ch.admin.bit.jeap.jme.messagetype.jme:jme-order-shipped-event](https://github.com/jme-admin-ch/jme-message-type-registry/tree/main)
 * ch.admin.bit.jeap.jme.messagetype.jme:jme-order-validated-event - [ch.admin.bit.jeap.jme.messagetype.jme:jme-order-validated-event](https://github.com/jme-admin-ch/jme-message-type-registry/tree/main)
