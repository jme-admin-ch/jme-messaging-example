...
- **ch.admin.bit.jeap:jeap-error-handling-service**: 24.5.0 → 24.6.0 (minor)
...
### Changed
- JEAP-6955: Demonstrate per-sequence recording configuration and add the required recording-provenance schema migration (V9).
- Update Sequential Inbox from 21.5.0 to 22.0.0.

## [11.0.0] - 2026-09-20

### Dependencies
- **ch.admin.bit.jeap:jeap-error-handling-service**: 24.4.0 → 24.5.0 (minor)
...
- **ch.admin.bit.jeap:jeap-error-handling-service**: 24.3.0 → 24.4.0 (minor)
...
- **ch.admin.bit.jeap:jeap-error-handling-service**: 24.2.0 → 24.3.0 (minor)
...
- **ch.admin.bit.jeap:jeap-error-handling-service**: 24.1.0 → 24.2.0 (minor)

## [10.1.0] - 2026-09-14

### Dependencies
- **ch.admin.bit.jeap:jeap-spring-boot-parent**: 41.1.0 → 41.2.0 (minor)
- **ch.admin.bit.jeap:jeap-error-handling-service**: 24.0.0 → 24.1.0 (minor)

## [10.0.0] - 2026-09-13

### Dependencies
- **ch.admin.bit.jeap:jeap-oauth-mock-server**: 10.10.0 → 11.0.0 (major)
- **ch.admin.bit.jeap:jeap-error-handling-service**: 23.4.0 → 24.0.0 (major)
